...
public class Delivery
{
  ...
  public Delivery(Time aTimePickedUp, Time aTimeDelivered, Driver aDriver, Order... allOrders)
  {
    ...
    if (!didAddDriver)
    {
      throw new RuntimeException("Unable to create delivery due to driver");
    }
